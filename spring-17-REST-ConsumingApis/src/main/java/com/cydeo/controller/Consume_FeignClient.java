...
private final EmployeeClient employee;

    public Consume_FeignClient(UserClient userClient, EmployeeClient employee) {
...
public ResponseEntity<ResponseWrapper>getEmployee(){
        return ResponseEntity.ok(new ResponseWrapper("Employee retrieved",employee.getEmployee("6298ebfecd0551211fce37a6")));
}
